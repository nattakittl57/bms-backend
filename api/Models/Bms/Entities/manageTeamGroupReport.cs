...
public class manageTeamGroupReport
{
...
public class ManageTeamGroupReportConfiguration : IEntityTypeConfiguration<manageTeamGroupReport>
{
    public void Configure(EntityTypeBuilder<manageTeamGroupReport> builder)
    {
        builder.ToTable("manageTeamGroupReport");
