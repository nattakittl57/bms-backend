...
public class programCategoryNBCT
{
...
public class ProgramCategoryNBCTConfiguration : IEntityTypeConfiguration<programCategoryNBCT>
{
    public void Configure(EntityTypeBuilder<programCategoryNBCT> builder)
    {
        builder.ToTable("programCategoryNBCT");
        builder.HasKey(e => e.prgCateNbctId);
        builder.Property(e => e.prgCateNbctId).IsRequired().HasColumnName("prgCateNbctId").HasColumnType("int");
